...
def index(id):
  ...
  with ix.searcher(closereader=False) as searcher:
    ...
    if center != "" and g_coords != "":
      url_static = "https://maps.googleapis.com/maps/api/staticmap?size=265x215&scale=2&sensor=false&visual_refresh=true&center="+str(center[0])+","+str(center[1])+"&path=color:0xff0000ff|fillcolor:0xff000022|weight:2|"+g_coords+"&key=AIzaSyB6EXuKPxGxdP5OA6TQmBMeouzBcB7SSds"
...
if __name__ == "__main__":
  ...
  run(host='0.0.0.0', port=8000, server='gunicorn', workers=4)
